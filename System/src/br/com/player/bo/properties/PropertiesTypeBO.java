...
public class PropertiesTypeBO {
	...
	public PropertiesType create(PropertiesType type) throws NamingException, SQLException, Exception {
		try {
			PropertiesType pojo = PropertiesTypeDAO.getInstance().create(type,
