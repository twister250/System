...
public abstract class SQLProperties {
	...
	protected static final String SQL_FIND_ALL_BY	= "select a.id, a.name, a.value, b.id type_id, b.name type_name, a.created, a.modified, a.user_id, c.name user_name from properties a, properties_type b, user c where a.properties_type_id = b.id and a.user_id = c.id";
}