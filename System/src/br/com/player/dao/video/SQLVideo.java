...
public abstract class SQLVideo {
	...
	protected static final String SQL_INSERT 	= "insert into video (name, description, file, filetype, video_property_id, created, modified, user_id) values (?, ?, ?, ?, ?, ?, ?, ?)";
	...
	protected static final String SQL_LIST 		= "select a.id, a.name, a.description, a.fileType, a.file, a.created, a.modified, a.user_id, b.name user_name from video a, user b where a.user_id = b.id";
}